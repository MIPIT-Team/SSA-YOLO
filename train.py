...
def parse_opt(known=False):
    ...
    parser.add_argument("--cfg", type=str, default=ROOT /'models/hub/yolov5s.yaml', help="model.yaml path")
    parser.add_argument("--data", type=str, default=ROOT / "data/NEU-DET.yaml", help="dataset.yaml path")
    parser.add_argument("--hyp", type=str, default=ROOT / "data/hyps/hyp.no-augmentation.yaml", help="hyperparameters path")
    ...
    parser.add_argument("--project", default=ROOT / "runs/train/p34", help="save to project/name")
    parser.add_argument("--name", default="DET_p34_NO", help="save to project/name")
